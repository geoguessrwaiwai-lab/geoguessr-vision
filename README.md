...
ラベリングツールは各地点について **Front/Back(真の進行方向とその180°反対、メイン)**、著作権年を読むための**Watermark**、埋め込みのStreet Viewビューアを表示します(`ground`帯はラベリング出力には含めません — front/backが既に見せている以上にはっきり車が写ることは稀なため)。
